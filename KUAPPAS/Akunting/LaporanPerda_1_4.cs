...
{
    public class LaporanPerda_1_4 : XLaporan
    {
        ...
        public bool CetakLaporanPerda(ParameterLaporan p)
        {
            try
            {
                PerdaRealisasi_1_4_Logic oLogic = new PerdaRealisasi_1_4_Logic(p.Tahun);
                List<PerdaRealisasi_1_4> lst = new List<PerdaRealisasi_1_4>();
        ...
        #region cetakPerda
        private bool CetakPerda(List<PerdaRealisasi_1_4>lst, ParameterLaporan pl)
        {
            ...
            try
            {
                ...
                foreach (PerdaRealisasi_1_4 r in lst)
                {
                    ...
                    pdfGridRow.Cells[5].Value = r.AnggaranOperasi.ToRupiahInReport();
                    pdfGridRow.Cells[6].Value = r.RealisasiOperasi.ToRupiahInReport();

                    pdfGridRow.Cells[7].Value = r.AnggaranModal.ToRupiahInReport();
                    pdfGridRow.Cells[8].Value = r.RealisasiModal.ToRupiahInReport();
                    pdfGridRow.Cells[9].Value = r.AnggaranTakTerduga.ToRupiahInReport();
                    pdfGridRow.Cells[10].Value = r.RealisasiTakTerduga.ToRupiahInReport();
                    pdfGridRow.Cells[11].Value = r.AnggaranTransfer.ToRupiahInReport();
                    pdfGridRow.Cells[12].Value = r.RealisasiTransfer.ToRupiahInReport();
                ...
                pdfGrid.Columns[8].Width = 70;
                pdfGrid.Columns[9].Width = 70;
                pdfGrid.Columns[10].Width = 70;
                pdfGrid.Columns[6].Width = 70;
                pdfGrid.Columns[11].Width = 70;
                pdfGrid.Columns[12].Width = 70;
        ...
        private bool TulisJudulLaporan(PdfGrid pdfGrid)
        {
            ...
            try
            {
                ...
                pdfGridHeader.Cells[4].Value = "Uraian Urusan, Organisasi, Program, Kegiatan dan Sub Kegiatan ";
                ...
                pdfGridHeader1.Cells[4].Value = "Uraian Urusan, Organisasi, Program, Kegiatan dan Sub Kegiatan ";

                pdfGridHeader1.Cells[5].Value = "Belanja Operasi";
                pdfGridHeader1.Cells[6].Value = "Belanja Operasi";

                pdfGridHeader1.Cells[7].Value = "Belanja Modal";
                pdfGridHeader1.Cells[8].Value = "Belanja Modal";

                pdfGridHeader1.Cells[9].Value = "Tidak Terduga";
                pdfGridHeader1.Cells[10].Value = "Tidak Terduga";
                ...
                pdfGridHeader2.Cells[4].Value = "Uraian Urusan, Organisasi, Program, Kegiatan dan Sub Kegiatan ";
