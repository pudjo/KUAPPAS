...
{
    public class LaporanPerkada_1_1 : XLaporan
    {
        ...
        private bool CetakPerda(List<PerdaRealisasi_1_3>lst, ParameterLaporan pl)
        {
            ...
            try
            {
                ...
                foreach (PerdaRealisasi_1_3 r in lst)
                {
                    ...
                    pdfGridRow.Cells[0].Value = r.KodeSubKegiatan.Trim() + r.Kode;
                    ...
                    pdfGridRow.Cells[6].Value = r.DasarHukum;
                ...
                pdfGrid.Columns[6].Width = 120;
                pdfGrid.Columns[7].Width = 120;
        ...
        private bool TulisJudulLaporan(PdfGrid pdfGrid)
        {
            ...
            try
            {
                ...
                pdfGridHeader.Cells[5].Value = "%";
                pdfGridHeader.Cells[6].Value = "Dasar Hukum";
                pdfGridHeader.Cells[7].Value = "Keterangan";
                ...
                pdfGridHeader1.Cells[3].Value = "Realisasi";

                pdfGridHeader1.Cells[4].Value = "Bertambah/(Berkurang)";
                pdfGridHeader1.Cells[5].Value = "%";
                pdfGridHeader1.Cells[6].Value = "Dasar Hukum";
                pdfGridHeader1.Cells[7].Value = "Keterangan";
